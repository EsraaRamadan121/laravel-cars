              ...
              <span class="d-inline-block d-lg-none"><a href="#" class=" site-menu-toggle js-menu-toggle py-5 "><span class="icon-menu h3 text-black"></span></a></span>
               ...
               <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="{{route('SHOW')}}" class="nav-link">Listing</a></li>
                  <li><a href="{{route('testimonials')}}" class="nav-link">Testimonials</a></li>
                  <li><a href="{{route('blog')}}" class="nav-link">Blog</a></li>
                  <li><a href="{{route('index')}}" class="nav-link">index</a></li>
        ...
        <div class="row">
          ...
          <form action="{{route('message')}}" method="post" enctype="multipart/form-data">
           @csrf
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Email address"name="Emailaddress" value="{{old('Emailaddress')}}">
                </div>
              </div>

              <div class="form-group row">
                <div class="col-md-12">
                  <textarea  name="content" id="" class="form-control" required="required" placeholder="Write your message." cols="30" rows="10" value="{{old('content')}}"></textarea>
                </div>
              </div>
              <div class="form-group row">
